 ...
 * @author mirian.rosa
 */
public class GestaoFaturamento extends javax.swing.JFrame {

    public static Usuario loggedUser;

    public GestaoFaturamento(Usuario user) {
        loggedUser = user;
        initComponents();
    ...
    private void readTable(){
        ...
        for (Contrato contra: fdao.read()){
            ...
            dtmContratos.addRow(new Object[]{  
                ...
                contra.getContrato(),
                contra.getPreco(),
                contra.getVencimento(),
                contra.getStatuspagamento()
            });   
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Faturamento de Contratos");
        ...
        jContratos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Cliente", "Contrato", "Preço", "Vencimento", "Status Pagamento"
            }
        ) {
    ...
    private void jContratosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jContratosMouseClicked
        ...
        if (jContratos.getSelectedRow() != -1){
            ...
            txtPreco.setText(jContratos.getValueAt(jContratos.getSelectedRow(), 3).toString());
            txtVencimento.setText(jContratos.getValueAt(jContratos.getSelectedRow(), 4).toString());
            txtMulta.setText("");
            txtJuros.setText("");
            txtStatuspagamento.setSelectedItem(jContratos.getValueAt(jContratos.getSelectedRow(), 5).toString());
        }
    ...
    private void botaoAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAtualizarActionPerformed
        ...
        if (jContratos.getSelectedRow() != -1){
            ...
            if (statusRight){
                ...
                contrato.setStatuspagamento((String) txtStatuspagamento.getSelectedItem());
                contrato.setPreco(preco);
                contrato.setId((int)jContratos.getValueAt(jContratos.getSelectedRow(),0));
                contratoDao.updatePaga(contrato);
                readTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestaoFaturamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
