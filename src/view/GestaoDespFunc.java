 ...
 * @author mirian.rosa
 */
public class GestaoDespFunc extends javax.swing.JFrame {

    public static Usuario loggedUser;

    public GestaoDespFunc(Usuario user) {
        loggedUser = user;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Despesa de Funcionários");
        ...
        jLabel3.setText("Ao clicar em Atualizar, o aumento e bônus");

        jLabel4.setText("serão aplicados ao salário automaticamente.");
        ...
        jFuncionarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "C.P.F.", "Salário", "Vencimento", "Status Pagamento"
            }
        ) {
    ...
    private void jFuncionariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jFuncionariosMouseClicked
        ...
        if (jFuncionarios.getSelectedRow() != -1){
            ...
            txtPreco.setText(jFuncionarios.getValueAt(jFuncionarios.getSelectedRow(), 3).toString());
            txtVencimento.setText(jFuncionarios.getValueAt(jFuncionarios.getSelectedRow(), 4).toString());
            txtStatuspagamento.setSelectedItem(jFuncionarios.getValueAt(jFuncionarios.getSelectedRow(), 5).toString());
            txtMulta.setText("");
            txtJuros.setText("");
        }      
    ...
    private void botaoAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoAtualizarActionPerformed
        ...
        if (jFuncionarios.getSelectedRow() != -1){
            ...
            if (statusRight){
                ...
                funcionario.setStatuspagamento((String) txtStatuspagamento.getSelectedItem());
                funcionario.setSalario(preco);
                funcionario.setId((int)jFuncionarios.getValueAt(jFuncionarios.getSelectedRow(),0));
                funcionarioDao.updatePaga(funcionario);
                readTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestaoDespFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
